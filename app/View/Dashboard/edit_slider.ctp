<h1>Edit Slider</h1>
<form action="<?php echo $this->webroot;?>dashboard/editsliderimg/<?php echo $id;?>" enctype="multipart/form-data" method="post" id="myform">
<label>Caption : </label><textarea class="required" name="caption" ><?php echo $slider['Slider']['caption'];?></textarea>
<label>Upload Image : </label><a id="upload" class="btn btn-info" href="javascript:void(0);">Upload</a> Minimum size 690 X 250
<hr />

<input type="hidden" name="image" class="image" value="<?php echo $slider['Slider']['image'];?>" />
<div class="thumb" style="margin: 10px 0;">
    <img src="<?php echo $this->webroot.'banners/'.$slider['Slider']['image'];?>" style="width:690x;"/>
</div>
