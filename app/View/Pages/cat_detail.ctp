                ...
                foreach ($category as $cat)
                    {
                        ...
                        echo "<h1>".$cat['Gallerycat']['title']."</h1>" ;
                            ...
                            <div class="mix-inner">
                                    ...
                                    <a class="mix-preview fancybox-button" href="<?php echo $this->webroot;?>galleryimgs/<?php echo $a['Galleryimg']['img']; ?>" title="<?php echo $a['Galleryimg']['title']; ?>" data-rel="fancybox-button">
