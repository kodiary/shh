...
<div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="description">
                                    ...
                                    foreach($media as $p)
                                    {
                                        ...
                                        <div class="medialist" style="margin-bottom: 10px;">
                                            ...
                                            <div class="action right col-md-1 col-sm-1 col-xs-12">
                                            <a href="javascript:void(0)" class="open-popup-link btn media " >View</a>
                                ...
                                <div class="popover" style="max-width: 610px;">
  ...
  $(".popover").html('<iframe src="http://docs.google.com/gview?url=<?php echo $this->Html->url('/', true);?>/doc/<?php echo $p['Media']['file'];?>&embedded=true" style="width:580px; height:300px;" frameborder="0"></iframe>');
